 ...
 * @author Maciej Urbanski <m.urbanski@samsung.com>
 * @author Piotr Karny <p.karny@samsung.com>
 * @author MichaÅ‚ Szepielak <m.szepielak@samsung.com>
 ...
 *
 * List item update function is responsible to update list element depending on data row index. If you didnâ€™t
 ...
 *
 * **Attention:** Virtual List manipulates DOM elements to be more efficient. It doesnâ€™t remove or create list
 ...
 * Itâ€™s highly recommended to destroy widgets, when they arenâ€™t necessary. To destroy Virtual List call destroy method.
 *
	vlist.destroy();
 *
 * ##Full working code
